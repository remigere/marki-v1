...
export const Hero = () => {
	return (
		<section
			className="bg-tory-blue-800 text-white overflow-hidden relative bg-no-repeat h-[26rem] md:h-[32rem] grid place-items-center"
			style={{
				backgroundImage:
		...
		>
			...
			<Container className="grid place-items-center gap-3 md:gap-6 text-center">
				<Typography as={"h1"} className="max-w-2xl z-10">
					Explore Our Handcrafted Meals
				</Typography>
				<Typography className="max-w-md z-10">
					We’ve meticulously designed meals backed by data to optimize
					nutrition
				</Typography>
			</Container>
		</section>
