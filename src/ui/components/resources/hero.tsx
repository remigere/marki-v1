...
export const Hero = () => {
	return (
		<section
			className="bg-salem-800 text-white overflow-hidden relative bg-no-repeat h-[26rem] md:h-[32rem] grid place-items-center"
			style={{
				backgroundImage:
					"url(/img/home/bg-vector-7.svg), url(/img/home/bg-vector-8.svg)",
		...
		>
			...
			<Container className="grid place-items-center gap-3 md:gap-6 text-center">
				...
				<Typography className="max-w-lg z-10">
					Nutritional science, health news, and recipes; it’s a
					knowledge party in one convenient spot.
				</Typography>
			</Container>
		</section>
	)
